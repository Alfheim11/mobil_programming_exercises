package com.example.wifi_bluetooth_kamera;
            ...
            public void onClick(View v) {
                if (bluetoothAdapter.isEnabled()) {
                    ...
                    if (pairedDevices.size() > 0) {
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<>(BluetoothActivity.this, android.R.layout.simple_list_item_1, cihazIsimleri);
